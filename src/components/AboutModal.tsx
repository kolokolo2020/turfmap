      ...
      >
        <div className="p-5">
          ...
          <p className="text-xs leading-relaxed mb-4" style={{ color: "var(--fg2)" }}>
            Hit <strong style={{ color: "var(--fg)" }}>Shuffle</strong> to jump to a random location. Artists who broke out in the last few years are marked <strong style={{ color: "var(--fg)" }}>Trending</strong> on their cards.
          </p>
